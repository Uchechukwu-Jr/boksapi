...
const items = require("./db/carousel.json");
...
app.post("/api/books", (req, res) => {
  try {
    ...
    newBook.id = uuidv4();
    Books.push(newBook);
    fs.writeFileSync("./db/BooksReverse.json", JSON.stringify(Books, null, 2));
...
app.get("/api/series/:series", (req, res) => {
  ...
  if (seriesBooks.length === 0) {
    return res
      .status(404)
      .json({ error: "No books found in the specified series." });
  }
